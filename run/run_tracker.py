...
tk = tracker.Tracker(num_templars=1, chkp='/storage/slurm/wangyu/imagenet15_vid/chkp/imgnetvid_4gpu_sgd2/imgnetvid_4gpu.ckpt-300000')
...
for frame_id in range(1, 2):
    ...
    draw_bbox(img_obj, tracked_bbox[0], save_dir + '/00000002.jpg', gt_bool=True)
    response *= 255.0
    Image.fromarray(response.astype(np.uint8)).save(save_dir + '/00000002_response.jpg')
