'''
The files generates PascalVOC12/ECSSD/MSRA10K augmented train tfrecords.
'''
...
def main(args):
    ...
    print('Generate PascalVOC12_ECSSD_MSRA10K Training tfrecords.')
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--source_dir', dest='source_dir',
                            default='/storage/slurm/wangyu/pascal_ecssd_mara_aug/')
    arg_parser.add_argument('--out-dir', dest='out_dir', default='/storage/slurm/wangyu/pascal_ecssd_mara_aug/tfrecord_train/')
